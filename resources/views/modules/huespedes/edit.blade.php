        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('huespedes') }}">Huespedes</a>
                </li>
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Formulario de Edición de Huesped</h5>

                        {{-- Formulario --}}
                        <form action="{{ route('huespedes.update', $huesped->id) }}" id="form_huesped" method="POST" class="row g-3">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text"
                                           ...
                                           id="apellido"
                                           name="apellido"
                                           value="{{ old('apellido', $huesped->apellido) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text"
                                           ...
                                           id="cedula"
                                           name="cedula"
                                           value="{{ old('cedula', $huesped->cedula) }}"
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="bi bi-save"></i> Actualizar Huesped
                                    </button>
                                </div>
                            </div>
                        </form>
